...
// AWS SKILL BUILDER: AWS CLOUD PRACTITIONER ESSENTIALS (CLF-C02)
// Course URL: https://skillbuilder.aws/learn/94T2BEN85A/aws-cloud-practitioner-essentials/8D79F3AVR7
const AWS_CPE_MODULES = [
  {
    id: 'cpe-mod-1',
    title: 'Module 1: Introduction to the Cloud',
    isCompleted: false,
    lessons: [
      l('What is Cloud Computing?', '8m'),
      l('Advantages of Cloud Computing', '6m'),
      l('Introduction to Amazon Web Services', '7m'),
      l('AWS Global Infrastructure Overview', '9m'),
      l('Ways to Interact with AWS Services', '5m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    id: 'cpe-mod-2',
    ...
    isCompleted: false,
    lessons: [
      l('Introduction to Amazon EC2', '10m'),
      l('EC2 Instance Types', '8m'),
      l('Amazon EC2 Pricing', '9m'),
      l('Scaling Amazon EC2', '10m'),
      l('Directing Traffic with Elastic Load Balancing', '7m'),
      l('Messaging and Queuing', '8m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('Serverless Computing with AWS Lambda', '8m'),
      l('Containers: ECS, EKS, and Fargate', '9m'),
      l('AWS Elastic Beanstalk', '6m'),
      l('AWS Lightsail', '5m'),
      l('AWS Batch & AWS Outposts', '7m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('AWS Regions and Availability Zones', '10m'),
      l('Edge Locations and AWS CloudFront', '8m'),
      l('AWS Local Zones and Wavelength', '6m'),
      l('How to Choose an AWS Region', '7m'),
      l('AWS Global Accelerator', '6m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('Connectivity to AWS: Amazon VPC', '11m'),
      l('Subnets and Network Access Control Lists', '9m'),
      l('Gateways and Route Tables', '8m'),
      l('Amazon Route 53', '7m'),
      l('AWS Direct Connect and AWS VPN', '8m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('Instance Stores and Amazon EBS', '8m'),
      l('Amazon Simple Storage Service (S3)', '10m'),
      l('S3 Storage Classes', '9m'),
      l('Amazon Elastic File System (EFS)', '6m'),
      l('Amazon S3 Glacier', '7m'),
      l('AWS Storage Gateway', '6m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('Relational Databases and Amazon RDS', '9m'),
      l('Amazon Aurora', '6m'),
      l('Amazon DynamoDB (NoSQL)', '8m'),
      l('Amazon Redshift (Data Warehousing)', '7m'),
      l('AWS Database Migration Service (DMS)', '6m'),
      l('Other AWS Database Services', '7m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('Introduction to AI/ML on AWS', '7m'),
      l('Amazon SageMaker', '7m'),
      l('AI/ML Services: Rekognition, Polly, Lex, Comprehend', '8m'),
      l('Amazon Bedrock and Generative AI', '7m'),
      l('Data Analytics: Athena, Glue, Kinesis', '8m'),
      l('Amazon QuickSight', '5m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('The AWS Shared Responsibility Model', '9m'),
      l('AWS Identity and Access Management (IAM)', '11m'),
      l('AWS Organizations and Service Control Policies', '8m'),
      l('Compliance: AWS Artifact & Compliance Programs', '6m'),
      l('Denial of Service (DDoS): AWS Shield & WAF', '8m'),
      l('Encryption: AWS KMS and AWS Secrets Manager', '7m'),
      l('Monitoring & Auditing: GuardDuty, Inspector, Macie', '8m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    id: 'cpe-mod-10',
    title: 'Module 10: Monitoring, Compliance, and Governance',
    isCompleted: false,
    lessons: [
      l('Amazon CloudWatch', '9m'),
      l('AWS CloudTrail', '7m'),
      l('AWS Config', '7m'),
      l('AWS Trusted Advisor', '8m'),
      l('AWS Health Dashboard', '5m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    lessons: [
      l('AWS Free Tier', '5m'),
      l('AWS Pricing Concepts & Calculator', '8m'),
      l('Billing Dashboard & Cost Explorer', '7m'),
      l('AWS Budgets & Cost Allocation Tags', '7m'),
      l('AWS Support Plans (Basic → Enterprise)', '9m'),
      l('AWS Marketplace', '5m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('AWS Cloud Adoption Framework (CAF)', '9m'),
      l('Migration Strategies: The 6 Rs', '8m'),
      l('AWS Snow Family (Snowcone, Snowball, Snowmobile)', '8m'),
      l('AWS Migration Hub & Transfer Services', '6m'),
      l('Innovation with AWS (EdgeComputing, IoT)', '7m'),
      l('Knowledge Check', '5m', 'QUIZ'),
    ]
  },
  {
    ...
    isCompleted: false,
    lessons: [
      l('The AWS Well-Architected Framework (6 Pillars)', '11m'),
      l('Benefits of AWS Cloud: The 6 Advantages', '7m'),
      l('AWS Well-Architected Tool', '5m'),
      l('Course Summary & Next Steps', '8m'),
      l('Final Practice Exam (Sample Questions)', '30m', 'QUIZ'),
    ]
  }
];
    ...
    courses: [
      {
        id: 'c-aws-cpe',
        provider: 'Other',
        title: 'AWS Cloud Practitioner Essentials (CLF-C02)',
        url: 'https://skillbuilder.aws/learn/94T2BEN85A/aws-cloud-practitioner-essentials/8D79F3AVR7',
        totalModules: AWS_CPE_MODULES.length,
        completedModules: 0,
        modules: AWS_CPE_MODULES,
        achievements: [
          { id: 'a-cpe-1', title: 'Cloud Believer', description: 'Complete Module 1: Introduction to the Cloud', xpReward: 400, icon: '☁️' },
          { id: 'a-cpe-2', title: 'Compute Commander', description: 'Complete Modules 2 & 3: Compute Services', xpReward: 700, icon: '⚡' },
          { id: 'a-cpe-3', title: 'Global Citizen', description: 'Complete Module 4: Going Global', xpReward: 500, icon: '🌍' },
          { id: 'a-cpe-4', title: 'Network Engineer', description: 'Complete Module 5: Networking', xpReward: 600, icon: '🔌' },
          { id: 'a-cpe-5', title: 'Storage Master', description: 'Complete Modules 6 & 7: Storage & Databases', xpReward: 700, icon: '🗄️' },
          { id: 'a-cpe-6', title: 'Security Sentinel', description: 'Complete Module 9: Security', xpReward: 900, icon: '🛡️' },
          { id: 'a-cpe-7', title: 'Cost Optimizer', description: 'Complete Module 11: Pricing & Support', xpReward: 600, icon: '💰' },
          { id: 'a-cpe-8', title: 'Cloud Practitioner', description: 'Complete all 13 modules — CLF-C02 Ready!', xpReward: 2000, icon: '🏆' }
        ]
      },
      {
        id: 'c-google-it',
